...
const ChangePassword = () => {
  ...
  const handleChangePass = async (e) => {
    ...
    try {
      const data = await authAPI.modifyPassword(
        user.email,
        password,
        newPassword
      );
  ...
  return (
    <Grid2 className="pass-container">
      ...
      <Typography variant="body1" className="subtitle">
        Para cambiar de contraseña ingresa primero tu contraseña actual. Luego
        ingresa la nueva contraseña en los dos campos siguientes.
      </Typography>
      ...
      {confirm && (
        <Alert
          severity="success"
          sx={{ marginTop: "10px", width: { xs: "80%", md: "60%" } }}
        >
          {confirm}
        </Alert>
      )}
